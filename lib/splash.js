...
export default function splash ({ path, name, org, coc, logo, active, total, channels, large, iframe }){
  let div = dom('.splash',
    ...
    dom('form id=invite',
      ...
      dom('p',
          'Sign into your Metamask account and enter your email below. \n Then, click the button below to sign a message and get your invite.'
      ),
    ...
    dom(`script src=${path}assets/bundle.js`)
  )
  return div
}
