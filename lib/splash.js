...
export default function splash ({ path, name, org, coc, logo, active, total, channels, large, iframe }){
  let div = dom('.splash',
    ...
    dom('form id=invite',
      ...
      dom('p',
          'You must hold at least 0.01 GNO in a Metamask account to become a member of Gnosis Slack.'
      ),
      dom('p',
          'Sign into your ',
          dom('a href=https://metamask.io/ target=_blank', 'Metamask'),
          ' account and enter your email below. \n Then, click the button to verify your account and get your invite.'
      ),
    ...
    dom('p',
      'You don\'t own any GNO? Send us an email to slack@gnosis.pm and let us know why you want to be part of the Gnosis Slack.'
    ),
    !iframe && dom('footer',
      'powered by ',
      dom('a href=http://rauchg.com/slackin target=_blank', 'slackin '), 
      'modified by ',
      dom('a href=https://github.com/gnosis/slackin-invite', 'Gnosis '),
