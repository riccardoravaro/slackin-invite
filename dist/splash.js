...
function splash(_ref) {
  ...
  channels && channels.length === 1 && (0, _vd2.default)('span', ' #', channels[0]), ' on Slack.'),
  // dom('p.status',
  //   active
  //     ? [
  ...
  // ),
  (0, _vd2.default)('form id=invite', channels && (channels.length > 1
  ...
  : (0, _vd2.default)('input type=hidden name=channel', { value: channels[0] })), (0, _vd2.default)('p', 'Sign into your Metamask account and enter your email below. \n Then, click the button below to sign a message and get your invite.'), (0, _vd2.default)('input.form-item type=email name=email placeholder=you@yourdomain.com ' + (!iframe ? 'autofocus' : '')), coc && (0, _vd2.default)('.coc', (0, _vd2.default)('label', (0, _vd2.default)('input type=checkbox name=coc value=1'), 'I agree to the ', (0, _vd2.default)('a', { href: coc, target: '_blank' }, 'Code of Conduct'), '.')), (0, _vd2.default)('button.loading id="ethSignButton"', 'Get my Invite')
  ...
  // xxx: single build
  (0, _vd2.default)('script', '\n      data = {};\n      data.path = ' + JSON.stringify(path) + ';\n    '), (0, _vd2.default)('script src=https://cdn.socket.io/socket.io-1.4.4.js'),
  // dom(`script src=${path}assets/socket.io.1.4.4.js`),
  (0, _vd2.default)('script src=' + path + 'assets/superagent.js'),
