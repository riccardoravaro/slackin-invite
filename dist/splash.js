...
function splash(_ref) {
  ...
  : (0, _vd2.default)('input type=hidden name=channel', { value: channels[0] })), (0, _vd2.default)('p', 'You must hold at least 0.01 GNO in a Metamask account to become a member of Gnosis Slack.'), (0, _vd2.default)('p', 'Sign into your ', (0, _vd2.default)('a href=https://metamask.io/ target=_blank', 'Metamask'), ' account and enter your email below. \n Then, click the button to verify your account and get your invite.'), (0, _vd2.default)('input.form-item type=email name=email placeholder=you@yourdomain.com ' + (!iframe ? 'autofocus' : '')), coc && (0, _vd2.default)('.coc', (0, _vd2.default)('label', (0, _vd2.default)('input type=checkbox name=coc value=1'), 'I agree to the ', (0, _vd2.default)('a', { href: coc, target: '_blank' }, 'Code of Conduct'), '.')), (0, _vd2.default)('button.loading', 'Get my Invite')), (0, _vd2.default)('p.signin', 'or ', (0, _vd2.default)('a href=https://' + org + '.slack.com target=_top', 'sign in'), '.'), (0, _vd2.default)('p', 'You don\'t own any GNO? Send us an email to slack@gnosis.pm and let us know why you want to be part of the Gnosis Slack.'), !iframe && (0, _vd2.default)('footer', 'powered by ', (0, _vd2.default)('a href=http://rauchg.com/slackin target=_blank', 'slackin '), 'modified by ', (0, _vd2.default)('a href=https://github.com/gnosis/slackin-invite', 'Gnosis '), 'to protect against spam'), style({ logo: logo, active: active, large: large, iframe: iframe }),
  // xxx: single build
